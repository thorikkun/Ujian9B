...
<body class="bg-gray-100">
    ...
    <nav class="bg-white shadow-md p-4">
        <div class="container mx-auto flex justify-between items-center">
            <a href="/" class="text-xl font-semibold text-gray-700">My Laravel App</a>
    ...
    <div class="container mx-auto mt-10 text-center">
        <h1 class="text-3xl font-bold"><a href="{{ route('products.index') }}" class="btn btn-primary">Lihat Produk</a>
        </h1>
        <p class="text-gray-600 mt-2">A simple Laravel authentication example with login and register buttons.</p>
    </div>
